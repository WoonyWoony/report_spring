...
public class SalesSearchDTO {
	...
	private String sales_year_min;
	private String sales_month_min;
	private String sales_date_min;
	private String sales_year_max;
	private String sales_month_max;
	private String sales_date_max;
	...
	public String getSales_year_min() {
		return sales_year_min;
	}
	public void setSales_year_min(String sales_year_min) {
		this.sales_year_min = sales_year_min;
	}
	public String getSales_month_min() {
		return sales_month_min;
	}
	public void setSales_month_min(String sales_month_min) {
		this.sales_month_min = sales_month_min;
	}
	public String getSales_date_min() {
		return sales_date_min;
	}
	public void setSales_date_min(String sales_date_min) {
		this.sales_date_min = sales_date_min;
	}
	public String getSales_year_max() {
		return sales_year_max;
	}
	public void setSales_year_max(String sales_year_max) {
		this.sales_year_max = sales_year_max;
	}
	public String getSales_month_max() {
		return sales_month_max;
	}
	public void setSales_month_max(String sales_month_max) {
		this.sales_month_max = sales_month_max;
	}
	public String getSales_date_max() {
		return sales_date_max;
	}
	public void setSales_date_max(String sales_date_max) {
		this.sales_date_max = sales_date_max;
	}
