						...
						<div class="col-12">
							<form name="loginForm" method="post" action="/ware/loginProc.do" class="tm-login-form">
								...
								<div class="form-group mt-3">
									...
									<input name="phone_num" type="text" class="form-control validate phone_num" id="phone_num" required />
								</div>
							</form>
							...
							<button class="mt-5 btn btn-primary btn-block text-uppercase" onclick="document.gologinForm.submit();">
								로그인 페이지
							</button>
						</div>
					</div>
