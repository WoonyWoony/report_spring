...
<head>
   ...
   <script>
      ...
      function setting(){
         ...
         CKEDITOR.instances.content.setData('<p>지난해 헬로웍스가 APM 시장서 점유율 1위로 시장을 선도했다.</p> <p>또한 침체기를 맞았던 EUE(엔드유저경험) 시장이 지난해 도약했다.</p> <p>데일리그리드(DailyGrid)의 리서치센터가 2018년 3월 5일부터 4월 10일까지 기업 및 공공기관을 대상으로 방문, 전화, 설문 등을 통해 APM 시장 조사를 실시했다.</p> <p>조사결과 WAS 모니터링, EUM 매출을 모두 포함한 2016년 전체 APM 시장은 272억원으로, 2015년 총매출인 256억원 대비 6.2% 증가했다.</p>');
      }
   </script>
</head>
