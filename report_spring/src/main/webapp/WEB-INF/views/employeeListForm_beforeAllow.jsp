...
<body id="reportsPage">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto h-100">
					...
					<li class="nav-item dropdown" id="hidden_item" hidden>
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown" style="width: 100%">
							<a class="dropdown-item " style="text-align: center" href="javascript:document.goEmployeeListForm.submit();">직원 관리</a>
							<a class="dropdown-item active" style="text-align: center"
								href="javascript:document.goEmployeeListForm_beforeAllow.submit();">가입 관리</a>
		...
		<div class="row tm-content-row">
			<div class="col-12 tm-block-col">
				<div class="tm-bg-primary-dark tm-block tm-block-h-auto tm-block-scroll" style="margin-bottom:80px">
					<h2 class="tm-block-title">가입관리</h2>
					<form name="employeeSearch" method="POST" action="/ware/employeeListForm_beforeAllow.do">
					...
					<table class="table employeeList2">
						<thead>
							<tr>
								...
								<th style="text-align: center" scope="col">가입상태</th>
							</tr>
						</thead>
						<c:forEach items="${requestScope.employeeList}" var="employee" varStatus="loopTagStatus">
							<tr style="cursor: pointer" onClick="goEmployeeUpDelForm(${employee.EMP_NO});">
								...
								<td style="text-align: center;">${employee.ALLOW_NAME}</td>
							</tr>
						</c:forEach>
						<c:if test="${employeeListAllCnt==0}">
							<tr>
								<td style="text-align: center;" colspan="9">검색된 직원이 없습니다.</td>
							</tr>
						</c:if>
					</table>
					<table class="table">
						<tr>
							<td width=33% align="left">
								<button style="max-width: 200px; font-size: 16px"
									...
									onclick="document.goEmployeeListForm.submit();">
									직원 관리 페이지 이동
								</button>
							</td>
	...
	<!-- https://getbootstrap.com/ -->
	<form name="employeeUpDelForm" method="post" action="/ware/employeeUpDelForm.do">
